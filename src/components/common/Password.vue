...
<template>
  <div class="gesturePwd">
    <div>
      ...
      <canvas ref="canvas" style="display: inline-block;"></canvas>
...
export default {
  ...
  methods: {
    ...
    drawCle(x, y) {
      ...
      this.ctx.lineWidth = this.detect() == "ios" ? "12" : "4";
      this.ctx.beginPath();
    ...
    initDom() {
      ...
      var height = this.height || this.detect() == "ios" ? 1200 : 400;
      // 高清屏锁放
